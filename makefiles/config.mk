...
CFLAGS += -DINSTALLDIR=\"$(INSTALLDIR)\" -DBASEDIR=\"$(BASEDIR)\" -DHOMEDIR=\"$(HOMEDIR)\" -DIMAGEDIR=\"$(IMAGEDIR)\" -DAPPIMAGEDIR=\"$(APPIMAGEDIR)\" -DFILENAMEDELIMITER=\"$(FILENAMEDELIMITER)\" -DPATHDELIMITER=\"$(PATHDELIMITER)\" -DEOLCHARS=\"$(EOLCHARS)\"
