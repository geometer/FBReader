...
#TODO: in S60, there's no libzcore.dso, ezlib.dso should be used instead
  CORE_LIBS = -l:libm.dso -L$(ROOTDIR)/zlibrary/ui -L$(ROOTDIR)/zlibrary/core -lzlcore -lzlui-$(UI_TYPE) -lzlcore  -l:QtGui.dso -l:QtCore.dso -l:QtNetwork.dso -l:expat.lib -l:libzcore.dso -l:bz2.lib $(FBREADER_LIBS) $(EXTERNAL_LIBS)
