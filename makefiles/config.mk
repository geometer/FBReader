...
ifeq "$(TARGET_ARCH)" "symbian"
  ...
  CORE_LIBS = -l:libm.dso -L$(ROOTDIR)/zlibrary/ui -L$(ROOTDIR)/zlibrary/core -lzlcore -lzlui-$(UI_TYPE) -lzlcore  -l:QtGui.dso -l:QtCore.dso -l:expat.lib -l:ezlib.dso -l:bz2.lib $(FBREADER_LIBS) $(EXTERNAL_LIBS)
