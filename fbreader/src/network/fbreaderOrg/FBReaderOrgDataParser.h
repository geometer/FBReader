...
#ifndef __FBREADERORGDATAPARSER_H__
#define __FBREADERORGDATAPARSER_H__

#include <ZLXMLReader.h>

#include "../NetworkBookInfo.h"

class FBReaderOrgDataParser : public ZLXMLReader {

public:
	FBReaderOrgDataParser(NetworkBookList &books);
