...
ShowNetworkTreeLibraryAction::ShowNetworkTreeLibraryAction() : ModeDependentAction(FBReader::BOOK_TEXT_MODE)  { }

void ShowNetworkTreeLibraryAction::run() {
    FBReader::Instance().setMode(FBReader::NETWORK_LIBRARY_MODE);
}
