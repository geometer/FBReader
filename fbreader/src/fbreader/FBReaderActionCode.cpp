...
const std::string ActionCode::VOLUME_KEY_SCROLL_FORWARD = "volumeKeyScrollForward";
const std::string ActionCode::VOLUME_KEY_SCROLL_BACKWARD = "volumeKeyScrollBackward";
