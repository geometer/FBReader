...
#ifndef __AUTHORDISPLAYNAMEENTRY_H__
#define __AUTHORDISPLAYNAMEENTRY_H__
...
public:
	AuthorDisplayNameEntry(OptionsDialog &dialog, shared_ptr<Author> initialAuthor, bool &visible);
...
#endif /* __AUTHORDISPLAYNAMEENTRY_H__ */
