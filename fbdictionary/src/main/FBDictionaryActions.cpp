...
ShowOptionsDialogAction::ShowOptionsDialogAction(FBDictionary &fbdictionary) : FBAction(fbdictionary) {
}
...
void ShowOptionsDialogAction::run() {
	...
	ZLDialogContent &tab = dialog->createTab(ZLResourceKey("view"));
	dialog->run();
}
