...
ZLDesktopOpenFileDialog::ZLDesktopOpenFileDialog(const ZLFileHandler &handler) : ZLOpenFileDialog(handler), WidthOption(OPTION_GROUP_NAME, "Width", 400), HeightOption(OPTION_GROUP_NAME, "Height", 300) {
}
