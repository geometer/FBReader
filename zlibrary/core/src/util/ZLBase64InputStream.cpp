...
std::size_t ZLBase64InputStream::read(char *buffer, std::size_t maxSize) {
	if (maxSize == 0) {
		return 0;
	}
	std::size_t offset = 0;
...
std::size_t ZLBase64InputStream::sizeOfOpened() {
...
std::size_t ZLBase64InputStream::offset() const {
