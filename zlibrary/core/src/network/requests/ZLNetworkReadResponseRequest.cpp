...
bool ZLNetworkReadResponseRequest::handleHeader(void *ptr, size_t size) {
	if (size == 0) {
		return true;
	}
...
bool ZLNetworkReadResponseRequest::handleContent(void *ptr, size_t size) {
	if (size == 0) {
		return true;
	}
...
bool ZLNetworkReadResponseRequest::doBefore() {
	return true;
}

void ZLNetworkReadResponseRequest::doAfter(bool) {
}
