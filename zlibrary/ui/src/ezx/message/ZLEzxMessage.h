...
#ifndef __ZLEZXMESSAGE_H__
#define __ZLEZXMESSAGE_H__

#include <qstring.h>

#include <ZLMessage.h>

class ZLEzxCommunicationManager : public ZLCommunicationManager {
