...
void KeyOptionView::_createItem() {
  ...
  myComboLabel = new QLabel(myWidget);
  myComboLabel->setText(::qtString(ZLResource::resource("keyOptionView")["actionName"].value()));
  layout->addWidget(myComboLabel, 1, 0);
